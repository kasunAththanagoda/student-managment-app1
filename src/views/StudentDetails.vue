  ...
  >
    <thead>
      <tr>
        ...
        <th class="text-left" width="170px">
          Lastname
        </th>
        <th class="text-left" width="280px">
          Email
        </th>
        <th class="text-left" width="100px">
          Course
 ...
 // name:'StudentDetails',
  ...
  methods:{
    getData(){
      ...
      console.log('Data was successfully retrieved from the JSON Server endpoint!');
  ...
  .catch(error => {
    console.error('An error occurred while retrieving data from the JSON Server endpoint.');
    console.log(error);
  });
    ...
    // editUser(id){
    //   <router-link :to="{name:'studentDetails'}" class="nav-link">student details</router-link>
    //  },
